...
if __name__ == '__main__' :
    ...
    originalDir = '/nfs_scratch/caillol/smhet2017_23may'
    targetDir = '/nfs_scratch/caillol/smhet2017_8jul_merged'
    jobId = ''
    channel = 'xx'
    ttreePath = 'etau_tree'
